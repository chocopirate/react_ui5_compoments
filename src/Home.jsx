          ...
          <List>
            ...
            >
              <FlexBox direction={FlexBoxDirection.Column}>
                <Title level={TitleLevel.H5}>Story 3</Title>
                <ProgressIndicator value={89} valueState={ValueState.Information} />
              </FlexBox>
            </StandardListItem>
            <StandardListItem
            ...
            >
              <FlexBox direction={FlexBoxDirection.Column}>
                <Title level={TitleLevel.H5}>Story 4</Title>
                <ProgressIndicator value={8} valueState={ValueState.Error} />
              </FlexBox>
            </StandardListItem>
          </List>
        </Card>
